...
def notice():
	...
	runtxt("\033[0;92m ADMIN🧞‍♀️ WATSAPPP🤲https:wa.me/+923025669420")
	subprocess.check_output(["am", "start", "https://wa.me/+03025669420"])
...
class Main:
	def __init__(self):
		...
		self.loop = 0
		try:
			plr = requests.get('https://pastebin.com/raw/3cNP2x7e.txt').text
			if basesplit in plr:
				key = basesplit
...
\033[1;33m██║░░██║██║██║░░██║███████╗
\033[1;35m╚═╝░░╚═╝╚═╝╚═╝░░╚═╝╚══════╝
\033[41m\033[1;37m[NAXIR]   [AJMAL]   [SAMEER]   [TOOR]\x1b[0m
\033[1;32m┌───────────────────────────────────────┐
\033[1;33m│ [✓] AUTHOR   : RIAZKHAN\033[1;32m[RRSN]         │
\033[1;34m│ [✓] GITHUB   : \033[41m\033[1;37mNAZIR\x1b[0m           │
\033[1;35m│ [✓] WHATSAPP :  03025669420           │
\033[1;36m│ [✓] POWER NAZIR : \x1b[1;32mPRO PRONOY\x1b[1;97m           │
\033[1;32m└───────────────────────────────────────┘  
         \033[41m\033[1;37m𝐓𝐎𝐎𝐋 𝐀𝐃𝐌𝐈𝐍 [NAZIR] [KHAN]\x1b[0m    
 """)
		print("%s [%s•%s] %sTOOL NAME : %sAJMALSHAH❌ PROO CLONER❌"%(G,R,G,B,G))
	...
	def api(self, uid, pwx):
		...
		sys.stdout.write(
			"\r\r %s[>_] [NAZIR] : %s/%s -> \033[0;92m [ NAZIR-OK:%s ]- \033[0;91m[ZWEX-CP:%s ]"%(B,self.loop, len(self.id), len(self.ok), len(self.cp))
		); sys.stdout.flush()
		for pw in pwx:
			pw = pw.lower()
			...
			if "session_key" in response.text and "EAAA" in response.text:
				...
				print("\r \033[0;91m[NAZIR-CP] %s|%s\033[0;97m         "%(uid, pw))
